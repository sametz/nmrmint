...
This version is to see if top boxes can be kept from filling x
"""
...
class VarBox(GuiMixin, Frame):
    ...
    def __init__(self, parent=None, text='', default=0.00, **options):
        ...
        Label(self, text=text).pack(side=TOP, expand=NO, fill=NONE)
        ent = Entry(self, validate='key', width=7)
...
VariablesBar.pack(side=TOP, expand=NO, fill=X)
...
TestBox2 = VarBox(VariablesBar, text='Test', default=0.00)
TestBox2.pack(side=LEFT, expand=NO, fill=NONE)
root.mainloop()
