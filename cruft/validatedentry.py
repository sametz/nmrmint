...
class EntryValidationDemo(ttk.Frame):
    ...
    def _create_demo_panel(self):
        ...
        # position panels
        integer.grid(in_=demoPanel, row=0, column=0, padx='3m', pady='1m',
                     sticky=EW)
        constraint.grid(in_=demoPanel, row=0, column=1, padx='3m', pady='1m',
                        sticky=EW)
        phone.grid(in_=demoPanel, row=1, column=0, padx='3m', pady='1m',
                   sticky=EW)
        pwd.grid(in_=demoPanel, row=1, column=1, padx='3m', pady='1m',
                 sticky=EW)
